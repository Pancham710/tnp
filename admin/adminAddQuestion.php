            ...
            <div class="col-8">
                <div>
                    <div class="card mt-4 border-top  border-primary">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="placedstudentnameid" class="form-label"> Enter the questions </label>
                                <input type="text-area" class="form-control" style="width: 100%;height: 500px;" name="placedstudentnameid"  >
                            </div>

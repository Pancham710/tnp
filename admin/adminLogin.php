            ...
            <div class="col-8">
                <div>
                    <div class="card mt-4 border-top  border-primary">
                        ...
                        <div class="card-body">
                        <form method="POST" action="./adminLoginAPI.php">
                            <div class="mb-3">
                                <label for="exampleFormControlInput1" class="form-label"> Username: </label>
                                <input type="email" name ="email" class="form-control" id="exampleFormControlInput1" placeholder="Enter Username" required>
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <p> <a href="#" style="color: blue; text-decoration: none;"> Show Password </a></p>
                            </div>
                        ...
                        <div class="card-body text-center">
                            <div class="m-2">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-info" style="width:50%;">Login</button>
                                </a>
                            </div>
